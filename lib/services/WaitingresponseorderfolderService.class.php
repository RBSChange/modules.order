...
{
	/**
	 * @var order_WaitingresponseorderfolderService
	 */
	private static $instance;

	/**
	 * @return order_WaitingresponseorderfolderService
	 */
	...
	{
		return $this->pp->createQuery('modules_order/waitingresponseorderfolder');
	}
	...
	{
		return $this->pp->createQuery('modules_order/waitingresponseorderfolder', false);
	}
