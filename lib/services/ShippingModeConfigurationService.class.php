<?php
/**
 * order_ShippingModeConfigurationService
 * @package modules.order.lib.services
 */
class order_ShippingModeConfigurationService extends BaseService
{
	/**
	 * Singleton
	 * @var order_ShippingModeConfigurationService
	 */
	private static $instance = null;

	/**
	 * @return order_ShippingModeConfigurationService
	 */
