 ...
 * @method order_OrderpreparationService getInstance()
 */
class order_OrderpreparationService extends f_persistentdocument_DocumentService
{
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_order/orderpreparation');
	}
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_order/orderpreparation', false);
	}
