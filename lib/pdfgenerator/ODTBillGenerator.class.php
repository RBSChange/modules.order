...
class order_ODTBillGenerator {
	...
	public function writePDF($bill, $filePath)
	{
		...
		$data['creationdate'] = date_Formatter::toDefaultDateTime($bill->getUICreationdate());
		$data['creationdatetime'] = date_Formatter::toDefaultDateTime($bill->getUICreationdate());
		...
		$billTemplate = $this->logoPath = f_util_FileUtils::buildProjectPath('modules','order','templates', $templateName);
